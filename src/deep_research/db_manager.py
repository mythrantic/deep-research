...
import lancedb
import pandas as pd 
from deep_research.storage import create_storage_provider, StorageConfig
from model_providers.embeddings import get_embedding_provider

storage_config = StorageConfig(provider="local", local_path="./lancedb_data")

class LanceDBManager:
    def __init__(self, storage_config: StorageConfig = storage_config):
        self.storage = create_storage_provider(storage_config)
        self.embedder = None
        self.db = None
        self.connect()
